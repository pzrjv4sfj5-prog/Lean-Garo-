...
read `docs/CLAUDE_A_SESSION_MIGRATION_20260822C.md` first — a
...
actually shipping at runtime today, Oe is master's VERIFIED tag, Hoe
is a third relay-confirmed candidate — none reconciled).
