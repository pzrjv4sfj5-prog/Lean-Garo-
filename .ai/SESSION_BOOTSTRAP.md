...
_Read this first, before `.ai/WORKSTATE.yaml`. Last updated: 2026-08-20c by Claude A (session close — see the new "NEW, 2026-08-20c" entry below for full detail: NV-086/087/088, a critical apostrophe-lookup runtime bugfix, 3 override-vs-master fixes, 4 compositional relay-batch closures)._
