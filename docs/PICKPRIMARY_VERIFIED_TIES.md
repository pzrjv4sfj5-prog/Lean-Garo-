...
hand-edit. 26 key(s) currently listed.
...
- `boy`: candidates — `me·a bi·sa`, `ko·ka` — shipped: `ko·ka`
...
- `girl`: candidates — `me·chik bi·sa`, `ko·ki` — shipped: `ko·ki`
...
- `walk`: candidates — `Re·a`, `re·am·a` — shipped: `re·am·a`
